...
export default function SignUpPage() {
  ...
  useEffect(() => {
    ...
    console.log("[signup] NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY:", pk ? `${pk.slice(0, 12)}...` : "MISSING");
  }, []);
      ...
      <div className="w-full max-w-sm">
        ...
        <SignUp.Root>
          <SignUp.Step name="start" className="space-y-4">
            ...
            <Clerk.GlobalError className="block text-sm text-red-500 bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/20 rounded-xl px-3 py-2" />
            ...
            <Clerk.Field name="username" className="space-y-1.5">
              <Clerk.Label className="text-xs font-medium text-muted">Username</Clerk.Label>
              <Clerk.Input type="text" placeholder="meepletronfan" className={inputCls} />
            ...
            <div
              ...
              className="empty:hidden flex justify-center"
            />
