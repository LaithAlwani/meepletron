...
const ContactForm = () => {
  ...
  return (
    <div className="max-w-xl mx-auto p-6 bg-gray-200 dark:bg-slate-800 rounded-lg shadow-md shadow-gray-400 dark:shadow-slate-700">
      <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">Can't find a Board Game?</h2>
      <p>Let us know which board game you cannot find and we will add it </p>
      <p></p>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <textarea
          ...
          rows="4"
          required></textarea>
        <CustomButton className="w-full" disabled={loading}>{loading ? <Loader width="1.5rem" /> : "Send Message"}</CustomButton>
