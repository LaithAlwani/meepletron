...
const RoadMap = () => {
  const stops = [
    ...
    },
    {
      ...
      date: "Late Q2 • 2025",
      description: "Introducing new user-focused features like personalized recommendations, and enhanced search tools."
    },
    {
      title: "Launch",
      description: "Official product release to the public",
      date: "Early Q3 • 2025",
      status: "coming",
    }
  ];
