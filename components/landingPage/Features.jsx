    ...
    <section id="features" className="max-w-4xl mx-auto py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card
            icon={<FaBoltLightning size={size} />}
            header="Instant"
            text1="Ask questions"
...
const Card = ({ icon, header, text1, text2, text3 }) => {
  return (
    <div className="border border-gray-300 bg-white dark:bg-slate-800 shadow-md w-64 mx-auto py-6 px-4">
      <span className="block mb-6">{icon}</span>
      <h4 className="text-3xl font-bold dark:text-yellow-500">{header}</h4>
